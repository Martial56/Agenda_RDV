...
urlpatterns = [
    ...
    path('ajax/patient-search/', views.patient_search_rdv, name='patient_search_rdv'),
    path('rapports/', views.rapport_page, name='rapport_page'),
    path('rapports/export/<str:rapport_type>/', views.rapport_export, name='rapport_export'),
